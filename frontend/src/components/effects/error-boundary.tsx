...
export class ErrorBoundary extends Component<ErrorBoundaryProps, ErrorBoundaryState> {
  ...
  render() {
    ...
    return (
      <div className="grid min-h-[220px] place-items-center rounded border border-border-light bg-panel p-6 text-center">
        <div>
          ...
          <button
            type="button"
            onClick={this.reset}
            className="mt-4 rounded border border-accent bg-accent-dim px-3 py-2 font-mono text-xs font-bold text-accent"
          >
            Retry panel
          </button>
        </div>
