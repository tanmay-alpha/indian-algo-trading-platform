    ...
    <div className="p-3 space-y-3 overflow-auto">
      ...
      {rebuild && (
        <div className="rounded border border-border bg-panel/60 p-3 space-y-2">
          <div className="text-[10px] font-semibold text-text">Portfolio Rebuild Summary</div>
          ...
          <div className="h-9 px-3 flex items-end gap-0.5 border-b border-border bg-bg-2 shrink-0">
            {OMS_TABS.map((tab) => (
              <button
                ...
                className={cn(
                  'h-8 px-3 flex items-center gap-1.5 rounded-t text-[10px] font-mono border-x border-t border-transparent transition-colors',
                  activeTab === tab.id
