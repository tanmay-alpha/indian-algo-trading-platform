    ...
    <div className="glass-card-3d rounded-lg p-4 border border-warn/10 text-left select-none relative overflow-hidden">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-white/[0.04] mb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            <h4 className="text-xs font-semibold text-white tracking-wider uppercase">AI Core Signal</h4>
            <p className="text-xs font-mono text-text-dim">Advisory analytics</p>
          </div>
        </div>
        <span className="px-2 py-0.5 rounded-full border border-warn/30 bg-warn/10 text-warn font-mono text-xs font-semibold tracking-wider flex items-center gap-1">
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between bg-white/[0.01] p-2.5 rounded border border-white/[0.02]">
          <div>
            <span className="text-xs text-text-faint block uppercase font-mono">{symbol} Signal</span>
            <span className={cn(
          ...
          <div className="text-right">
            <span className="text-xs text-text-faint block uppercase font-mono">Confidence</span>
        ...
        <div className="bg-white/[0.01] p-2.5 rounded border border-white/[0.02]">
          <span className="text-xs text-text-faint block uppercase font-mono mb-1 flex items-center gap-1">
        ...
        <div className="text-xs text-text-dim font-mono flex items-center gap-1.5 opacity-60">
