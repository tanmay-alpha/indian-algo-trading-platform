  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-0.5">
        ...
        <span className="text-[9px] text-text-dim max-w-xs leading-relaxed">
          {message}
        </span>
      </div>
      ...
      {onRetry && (
        <button
          onClick={onRetry}
          className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-sm border border-down/30 bg-bg text-[9px] text-down hover:bg-down/10 hover:border-down transition-colors active:scale-95 duration-100"
        >
