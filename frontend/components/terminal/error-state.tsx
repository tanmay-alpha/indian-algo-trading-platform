  ...
  return (
    ...
    >
      ...
      {onRetry && (
        <button
          onClick={onRetry}
          className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-sm border border-down/30 bg-bg text-xs text-down hover:bg-down/10 hover:border-down transition-colors active:scale-95 duration-100"
        >
