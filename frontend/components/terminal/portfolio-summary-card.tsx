    ...
    <div className="glass-card-3d rounded-lg p-4 border border-[#38bdf8]/10 text-left select-none relative overflow-hidden">
      ...
      <div className="flex items-center justify-between pb-3 border-b border-white/[0.04] mb-3">
        <div className="flex items-center gap-2">
          ...
          <div>
            ...
            <p className="text-[9px] font-mono text-text-dim">Read-only status</p>
          </div>
        </div>
        <span className="px-2 py-0.5 rounded-full border border-info/30 bg-info/10 text-info font-mono text-[9px] font-semibold tracking-wider">
          SIMULATED
        </span>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="bg-white/[0.01] p-2.5 rounded border border-white/[0.02] flex items-center justify-between">
          <div>
            <span className="text-[9px] text-text-faint block uppercase font-mono">Net Portfolio Value</span>
            <span className="text-sm font-bold text-white font-mono tracking-wider block mt-0.5">
              {formattedValue}
            </span>
          </div>
          <div className="text-right">
            <span className="text-[9px] text-text-faint block uppercase font-mono">Total PnL</span>
            <span className={cn(
        ...
        <div className="grid grid-cols-2 gap-2 text-xs font-mono">
          <div className="bg-white/[0.01] p-2 rounded border border-white/[0.02]">
            <span className="text-[9px] text-text-faint block uppercase">Available Margin</span>
            <span className="font-semibold text-white block truncate mt-0.5">{formattedMargin}</span>
          </div>
          <div className="bg-white/[0.01] p-2 rounded border border-white/[0.02]">
            <span className="text-[9px] text-text-faint block uppercase">Reconciliation</span>
